            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16, animation: 'fadeUp .5s ease both' }}>
              <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: 20, alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <p style={{ color: 'rgba(255,255,255,.5)', fontSize: 13, lineHeight: 2, maxWidth: 520, marginBottom: 14 }}>
                    What started as a personal journey from being underweight at 58kg became a deep pursuit of strength, structure, and physical development. Through consistent training and discipline, I built myself up to 73kg—learning firsthand what it takes to grow, not just physically, but mentally. That process sparked a lasting interest in human movement, performance, and adaptation—shaping how I approach training today.               </p>
                  <p style={{ color: 'rgba(255,255,255,.38)', fontSize: 12.5, lineHeight: 2, maxWidth: 520 }}>
                    With a background in physiotherapy, my focus goes beyond just lifting heavier. Movement quality comes first, followed by strength built with control. Every program is designed for long-term progress, not just short-term results.                  </p>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(160px,1fr))', gap: 10 }}>
                {[
                  ...
                  { label: 'Online & In-Person', sub: 'Abuja · London · Virtual' },
                ].map(item => (
