  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', top: 24, left: '50%', transform: 'translateX(-50%)', textAlign: 'center', zIndex: 10, pointerEvents: 'none', whiteSpace: 'nowrap' }}>
        <div style={{ fontFamily: "'Space Mono',monospace", fontSize: 9, letterSpacing: 6, color: 'rgba(160,60,100,.45)', marginBottom: 4 }}>PENCIL · INK · PAINT</div>
        <h2 style={{ fontFamily: "'Caveat',cursive", fontSize: 'clamp(22px,2.8vw,36px)', fontWeight: 700, color: '#1a0810' }}>Studies in Form</h2>
      </div>
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ color: 'rgba(20,5,12,.44)', fontSize: 13, lineHeight: 1.9, fontFamily: "'Syne',sans-serif" }}>
            Pencil drawings and paintings that explore form, shadow, and subdued emotion. The work leans into quieter, sometimes heavier moments—where observation gives way to feeling.          </p>
        </div>

        {/* Achievement list */}
        <div style={{ borderTop: '1px solid rgba(20,5,12,.1)', paddingTop: 16 }}>
          {[
            'Independent Artist Practice',
            'Pencil, Ink & Paint Mediums',
            'Exploring Form & Expression',
